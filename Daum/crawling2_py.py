...
driver.get('https://search.daum.net/search?w=news&nil_search=btn&DA=STC&enc=utf8&cluster=y&cluster_page=1&q=%EC%A4%91%EA%B5%AD&sd=20210425000000&ed=20210502235959&period=u')
count = 1
page_num = 0

while len(comments_list) <= 1000 and len(likes_list) <= 2000:
    try:
        if count == 11:
            if page_num == 5:
                count = 1
